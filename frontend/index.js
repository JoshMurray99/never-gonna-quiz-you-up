...
function updateLeaderboard(data, subject) {
    ...
    if (subject === "geography") {
        geoLeaderboard.children[1].childNodes[1].textContent = `${data[0].name} - ${data[0].score}`;
        geoLeaderboard.children[1].childNodes[3].textContent = `${data[1].name} - ${data[1].score}`;
        geoLeaderboard.children[1].childNodes[5].textContent = `${data[2].name} - ${data[2].score}`;
    } else if(subject === "history") {
        histLeaderboard.children[1].childNodes[1].textContent = `${data[0].name} - ${data[0].score}`;
        histLeaderboard.children[1].childNodes[3].textContent = `${data[1].name} - ${data[1].score}`;
        histLeaderboard.children[1].childNodes[5].textContent = `${data[2].name} - ${data[2].score}`;
    }
}
